...
namespace ProjectFinal1.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<AppilcationUser> signInManager, ILogger<LoginModel> logger)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = await _signInManager.PasswordSignInAsync(Input.Transcode, Input.Password, Input.RememberMe, lockoutOnFailure: false);
                if (result.Succeeded)
                {
